...
public class TraceFunFieldConfigParam implements Comparable<TraceFunFieldConfigParam>{
	...
	@NotEmpty
	@ApiModelProperty(value = "**-字段类型,1、表示文本，2、多行文本，3 表示单选 4、多选 5、表示金额，6 表示日期，7表示时间，8表示日期和时间，9 表示图片，10 表示附件，11 表示邮箱，12 表示网址，13 表示对象，14表示手机，15数字",notes="注意如果选择的是13对象类型传递的字段类型为13_具体类型，如：13_varchar(10)", required=true)

...
public class TraceFunTemplateconfigListParam extends DaoSearch {
    ...
    public TraceFunTemplateconfigListParam(Long id, String traceTemplateId, String traceTemplateName, String organizationId, Integer nodeCount, String traceBatchNum, String createMan, String createTime, String businessTypes, String nodeFunctionId, String nodeFunctionName, Integer nodeWeight) {
        this.id = id;

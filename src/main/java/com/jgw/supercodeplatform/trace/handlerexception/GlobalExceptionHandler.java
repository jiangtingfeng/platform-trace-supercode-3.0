package com.jgw.supercodeplatform.trace.handlerexception;
...
public class GlobalExceptionHandler {
    ...
    public RestResult handleException(Exception e) {
        ...
        RestResult RestResult = new RestResult(HttpStatus.INTERNAL_SERVER_ERROR.value(), "server error:" + e.getMessage(), null);
        return RestResult;
    }
     ...
     */
    @ResponseStatus(HttpStatus.OK)
    @ExceptionHandler(SuperCodeTraceException.class)
    public RestResult codePlatformException(SuperCodeTraceException e) {

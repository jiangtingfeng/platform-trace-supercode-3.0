...
import com.jgw.supercodeplatform.trace.exception.ExcelException;
import jxl.Cell;
import jxl.Sheet;
import jxl.Workbook;
...
public class ExcelUtils {
     ...
     */
    public static <T> void listToExcel(List<T> list, Map<String, String> fieldMap, String sheetName, int sheetSize, OutputStream os, WriteSheet we) throws ExcelException {
...
//            throw new ExcelException("数据源中没有任何数据");
     ...
     */
    public static <T> void listToExcel(List<T> list, Map<String, String> fieldMap, String sheetName, OutputStream os) throws ExcelException {
        listToExcel(list, fieldMap, sheetName, 65535,os,null);
    }
     ...
     */
    public static <T> void listToExcel(List<T> list, Map<String, String> fieldMap, String sheetName, int sheetSize, HttpServletResponse response, WriteSheet we) throws ExcelException {
        // 文件名默认设置为当前时间：年月日时分秒
        ...
        try {
            ...
            listToExcel(list, fieldMap, sheetName, sheetSize, os,we);
        } catch (Exception e) {
            e.printStackTrace();
     ...
     */
    public static <T> void listToExcel(List<T> list, Map<String, String> fieldMap, String sheetName, HttpServletResponse response, WriteSheet we) throws ExcelException {
        listToExcel(list, fieldMap, sheetName, 65535, response,we);
    }

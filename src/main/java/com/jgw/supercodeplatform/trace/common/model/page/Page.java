package com.jgw.supercodeplatform.trace.common.model.page;
...
public class Page implements Serializable{
	 ...
	 * @throws Exception
	 */
    public Page(int pageSize,int current,int total) throws SuperCodeTraceException{
    	if(pageSize < 1 || current < 1){
    		throw new SuperCodeTraceException("每页记录数或者当前页的值小于1");
    	}
    	this.pageSize = pageSize;
    	this.current = current;
    	this.total = total;
